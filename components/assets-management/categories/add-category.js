        ...
        <div className="flex h-3/4 justify-center items-center">
            <div className="w-[480px] max-w-full h-auto bg-white drop-shadow-md rounded-lg flex flex-col justify-center">
                <div className="py-8 px-8 space-y-4">
                    <h2 className="text-lg font-semibold text-gray-800 mb-2">New Category</h2>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        />
                        <label htmlFor="is_required_add" className="text-sm font-medium text-gray-700">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                            placeholder={`e.g. "Would you like to use this equipment?"`}
