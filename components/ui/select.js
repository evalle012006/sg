...
const SelectComponent = (props) => {
    ...
    return (
        <div className="mb-6" style={{ width: props.width }}>
            ...
            <div className="flex justify-between items-center px-3.5 py-2.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-lg shadow-sm transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-slate-400 focus:outline-none;" onClick={handleOpenDropdown}>
                <input
            ...
            {dropdownOpen && (
                <div className="relative">
                    <div className="absolute drop-shadow-xl mt-1 z-30 top-1 bg-white rounded-lg border border-gray-100 w-full block overflow-x-auto">
                        {options.length > 0 ? (
                            <>
